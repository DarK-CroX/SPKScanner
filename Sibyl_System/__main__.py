...
async def status(event):
    msg = await event.reply("Conecting to Special Provisions for Kira!\nContacting Inspector L.")
    time.sleep(2)
    await msg.edit("Wasting time ★☆☆☆☆☆")
    time.sleep(1)
    await msg.edit("Wasting time ★★☆☆☆☆")
    time.sleep(1)
    await msg.edit("Wasting time ★★★☆☆☆")
    ...
    await msg.edit("Wasting time ★★★★★★")
    time.sleep(1)
    await msg.edit("Successfully Wasted Time! ")
    time.sleep(1)
